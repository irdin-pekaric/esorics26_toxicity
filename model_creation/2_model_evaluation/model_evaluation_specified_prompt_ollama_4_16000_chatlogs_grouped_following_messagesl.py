...
DEFAULT_PROMPT = (
    'Please read the following chat messages from a league of legends match, grouped by immediatly following messages sent by one player, and decide whether it is TOXIC.\n'
    ...
    for enc in encs:
        for sep in seps:
            try:
                ...
                # prefer the widest parse (most columns)
